...
search: {
 ...
 api: {
  apiKey: 'f321aa6cee171d4fe744270e5be1263d',
...
// displayBackgroundImage ond details pages
...
function displayPagination() {
  ...
  //disabled prev if on first page
  if (global.search.page === 1) {
    document.querySelector('#prev').disabled = true;
  }
//disabled next if on last page
